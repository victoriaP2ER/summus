...
const STYLE_DEFS: Style[] = [
  ...
  },
  {
    ...
    label: 'Classic Rock',
    emoji: '🎸',
    hint: 'Riff-Gitarren, Orgel und ein Bass, der schiebt — zum Reinsingen gemacht',
    bpm: 132,
    scaleId: 'mixolydian',
    lead: 'guitarCrunch',
    chords: 'guitarCrunch',
  ...
  },
  {
    ...
    sets: [
      ...
      // The piano trio: the piano carries the tune and comps underneath it.
      { lead: 'piano', chords: 'piano', bass: 'contrabass' },
  ...
  },
  {
    ...
    bass: 'bass',
    alternates: ['trumpet', 'sax'],
    picks: ['strings', 'piano', 'guitarClean', 'trumpet', 'trombone', 'sax', 'organ', 'bass', 'vibraphone', 'wurlitzer', 'bassGuitar'],
    sets: [
      { lead: 'strings', chords: 'piano', bass: 'bass' },
